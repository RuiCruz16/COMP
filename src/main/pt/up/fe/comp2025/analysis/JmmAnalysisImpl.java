...
public class JmmAnalysisImpl implements JmmAnalysis {
    ...
    private List<AnalysisVisitor> buildPasses(SymbolTable table) {
        return List.of(new UndeclaredVariable(), new IncompatibleOperandType(), new ArrayAccess()); // TODO, add here the different AnalysisVisitor implementations for each pass
    }
